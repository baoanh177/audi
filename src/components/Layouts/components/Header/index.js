...
import { dataContext } from "~/components/API"
...
function Header() {
    ...
    return (
        <header>
                                ...
                                {active == category.id &&
                                    <div className={Styles.dropDown}>
                                        ...
                                        <div className={Styles.more}>
                                            <div>
                                                <img src={category.child.more.thumb} alt="" />
                                            </div>
                                            <a href={category.child.more.path}>
                                                <span>{category.child.more.title}</span>
            ...
            <Search styles={Styles} setActive={setActive}/>
        </header>
    )
}
